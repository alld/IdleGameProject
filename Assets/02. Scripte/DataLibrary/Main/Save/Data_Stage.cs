...
namespace IdleGame.Data
{
    ...
    {
        /// <summary>
        /// [데이터] 스테이지의 구성 최대레벨을 나타냅니다.
        /// </summary>
        public int maxLevel = 0;
        /// <summary>
        /// [상태] 현재까지 진행중인 레벨을 나타냅니다. 
        /// <br> (동적 데이터) </br>
        /// </summary>
        ...
        /// <summary>
        /// [데이터] 각 레벨별 등장하는 몬스터의 수를 지정합니다.
        /// </summary>
        public int[][] level_unitCount;

        /// <summary>
        /// [데이터] 각 레벨별 등장하는 몬스터의 종류를 지정합니다. 
        /// </summary>
        public int[][] level_unitKind;
